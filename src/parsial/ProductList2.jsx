...
import { ProdctTwo } from "../parsial/Main"
...
function ListProduct2(){
    ...
    const { id } = useParams()
    const result = ProdctTwo.find((item) => item.id == id)
          ...
          <div className="list-product">
                ...
                <div className="list-product-mtn">
                    ...
                    <div className="list-product-price">
                        <p>${result.price} <img src={result.off} alt="" /><img src={result.ooff} alt="" className="list-product-price-img"/></p>
                    </div>
